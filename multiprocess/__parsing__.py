...
def parse_video_basic(video_soup):
    ''' Reading a video soup object, return a dict for href, imgurl, fname
    '''
    href = video_soup.find('a')['href']
    ...
    return {'href':href, 'img_url':img_url, 'title':title, 'info':info, 'fname':fname}
